 ...
 *   <li>추천수 >= minRecommendation AND 비추천수 + 0 < 추천수 (아카라이브는 비추천 없음)</li>
 *   <li>댓글수 >= minCommentCount (DB 설정, 기본 15)</li>
 * </ul>
 */
@Component
public class ArcaliveNotificationFilter implements DealNotificationFilter {

  private static final int RECOMMENDATION_MARGIN = 0;

  @Override
  public DealSiteCode getSiteCode() {
    return DealSiteCode.ARCALIVE;
  }
