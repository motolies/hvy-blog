 ...
 * <ul>
 *   <li>조회수 >= minViewCount (DB 설정, 기본 5000)</li>
 *   <li>추천수 >= minRecommendation AND 비추천수 + 0 < 추천수 (루리웹은 비추천 없음)</li>
 *   <li>댓글수 >= minCommentCount (DB 설정, 기본 15)</li>
 * </ul>
 */
@Component
public class RuliwebNotificationFilter implements DealNotificationFilter {

  private static final int RECOMMENDATION_MARGIN = 0;

  @Override
  public DealSiteCode getSiteCode() {
    return DealSiteCode.RULIWEB;
  }
