...
DROP TABLE IF EXISTS tb_advisor_pick_note CASCADE;
...
DROP TABLE IF EXISTS tb_stock_event_timeline CASCADE;
DROP TABLE IF EXISTS tb_stock_macro_daily CASCADE;
